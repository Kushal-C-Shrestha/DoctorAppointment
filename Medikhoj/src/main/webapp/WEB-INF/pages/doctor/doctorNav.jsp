...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/doctorNav.css"/></head>
      ...
      <div class="nav-links__container">
        ...
        <div class="nav-section">
          ...
          <ul>
            ...
            <li class="nav-link">
              <a href="${pageContext.request.contextPath}/doctorAppointment">My Appointments</a>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="25"
                  height="25"
