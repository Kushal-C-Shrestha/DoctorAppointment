    ...
    <div class="reviews-list">
        <div class="reviews-card">
            <div class="reviews-info">
              ...
              <div>
                <div class="reviews-name">Anugrah Chor</div>
                <p class="reviews-bio">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis, eius sit adipisci ab vel placeat ducimus similique hic soluta eaque aut <br>ad esse autem cumque non veritatis maiores magnam modi.</p>
              </div>
            </div>
