<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>    
       <c:set var="page" value="campaigns"></c:set>
...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/adminCampaign.css"/></head>
    ...
    <div class="campaign-list">
      <div class="campaign-card">
        <div class="campaign-info">
          ...
          <span>Healthy Living Initiative</span>
        </div>
      ...
      <div class="campaign-card">
        <div class="campaign-info">
          ...
          <span>Preventive Care Campaign 2025</span>
        </div>
        <div class="campaign-actions">
          <button class="edit-btn">
            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="pencil-icon">
